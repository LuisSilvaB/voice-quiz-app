...
import { deleteFragment, setTargetFragment } from "../../../../features/fragments.features";
...
const FragmentsCard:React.FC<Props> = ({fragment}) => {
    ...
    const onDeleteFragment = () => {
        dispatch(deleteFragment(fragment))
    }
  return (
    <div className="flex h-fit text-xs w-full cursor-pointer flex-col gap-3 rounded-xl border hover:border-gray-400 bg-white p-3 shadow-sm transition-all">
      ...
      <div className="h-full max-h-[60px] flex-nowrap overflow-y-hidden text-ellipsis font-normal">
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex flex-row gap-2">
          <IconButton placeholder={""} className="bg-gray-200" onClick={onDeleteFragment}>
